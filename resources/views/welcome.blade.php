    ...
    <div class="w-11/12 md:w-5/6 mx-auto flex md:h-full">
        <div class="w-2/5 md:h-full flex items-center align-middle justify-center"><div class="block w-11/12 mx-auto">
            ...
            <div class="flex items-center justify-content-center">
                <a href="{{url('/home')}}" class="my-6 mx-auto py-2 px-5 border-2 border-blue-800 hover:shadow-inner bg-purple-300 transition-all text-blue-800 text-3xl rounded-r-full rounded-l-full">Welcome Home</a>
            </div>
        </div></div>
        <div class="w-3/5 md:h-full flex items-center align-middle justify-center bg-purple-900">
            <div class="w-11/12 flex flex-col justify-around my-4 py-1 rounded-md mx-auto">
                <div class="w-full py-2 flex-auto">
                    <img src="{{asset('img/iconus.png')}}" alt="" class="w-24 h-auto my-6 mx-auto rounded-full border-2 border-blue-800">
