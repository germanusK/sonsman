...
<div class="w-full md:h-screen">
    <div class="w-11/12 md:w-5/6 mx-auto flex md:h-full">
        ...
        <div class="w-3/5 md:h-full flex items-center align-middle justify-center bg-blue-50">
            <div class="w-11/12 flex flex-col justify-around my-4 py-1 rounded-md mx-auto bg-purple-900">
