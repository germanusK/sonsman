<div class="w-full h-auto bg-stone-900 text-slate-200 relative">
    <div class="h-full w-11/12 flex align-middle items-stretch justify-between mx-auto py-3 relative">
        ...
        <div id="nav-box" class="h-fit w-fit hidden flex-wrap justify-end text-lg  font-normal flex-auto gap-x-2 gap-y-2 divide-blue-600 bg-transparent">
        ...
        <button class="self-end" id="nav-toggler" onclick="toggle_nav()"><span class="fas fa-bars text-slate-200 text-2xl font-semibold"></span></button>
        <button onclick="toggle_search()" class=" self-end px-2 mx-2 my-2 rounded-3xl border-2 border-blue-800 h-fit md:bg-transparent">search</button>
    </div>
    <div id="seach-box" class="hidden h-full bg-white opacity-90  w-full">
        <x-search-component/>
    </div>
...
<div class="w-full min-h-screen relative ">
    ...
    <div class="w-2/5 absolute flex top-0 right-0 border-b-8 border-l-8 rounded-bl-full border-white z-20 bg-stone-900 justify-center items-center align-middle flex-wrap pl-4 py-4">
        <a href="{{ url('') }}" class="mx-4"><span class="text-4xl font-semibold text-slate-200 fas fa-home"></span></a>
        <a href="{{ url('/login') }}" class="mx-4"><span class="text-4xl font-sans mx-5 text-blue-300 fas fas fa-sign-in-alt"></span></a>
    </div>
</div>
<script>
