<div class="w-full h-auto bg-stone-900 text-slate-200">
    <div class="h-full w-11/12 flex align-middle items-center mx-auto py-3 relative">
        ...
        <div id="nav-box" class="h-fit w-fit inline-block md:flex flex-wrap justify-end text-lg  font-normal flex-auto gap-x-2 gap-y-2 divide-blue-600 bg-transparent">
        ...
        <button class="absoute right-3 top-2" id="nav-toggler" onclick="toggle_nav()"><span class="fas fa-bars text-slate-200 text-2xl font-semibold"></span></button>
    </div>
