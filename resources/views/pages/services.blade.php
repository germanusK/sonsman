...
<div class="w-full">
    <div class="w-full flex flex-col flex-wrap justify-center sl1">
        <div class="w-full h-full lg:flex border-y-2 border-d border-double">
            <div class="w-full lg:w-1/2 h-full text-center text-xlarge text-s font-black capitalize flex flex-col justify-center">Our Services</div>
    ...
    <div class="w-full h-auto flex flex-wrap justify-center bg-p py-14">
        <div class="w-52 h-36 mx-5 relative my-6">
            <span class="absolute -top-1/4 left-0 text-xlarge text-s fas fa-globe bg-p rounded-full p-2"></span>
            <div class="w-full h-5/6 border-4 border-d rounded-md text-s text-large capitalize align-middle flex flex-col justify-center font-semibold text-center">Web development</div>
        </div>
        <div class="w-52 h-36 mx-5 relative my-6">
            <span class="absolute -top-1/4 left-0 text-xlarge text-s fas fa-mobile-alt bg-p rounded-full p-2"></span>
            <div class="w-full h-5/6 border-4 border-d rounded-md text-s text-large capitalize align-middle flex flex-col justify-center font-semibold text-center">Mobile development</div>
        </div>
        <div class="w-52 h-36 mx-5 relative my-6">
            <span class="absolute -top-1/4 left-0 text-xlarge text-s fas fa-lightbulb bg-p rounded-full p-2"></span>
            <div class="w-full h-5/6 border-4 border-d rounded-md text-s text-large capitalize align-middle flex flex-col justify-center font-semibold text-center">SEO</div>
        </div>
        <div class="w-52 h-36 mx-5 relative my-6">
            <span class="absolute -top-1/4 left-0 text-xlarge text-s fas fa-mars-stroke bg-p rounded-full p-2"></span>
            <div class="w-full h-5/6 border-4 border-d rounded-md text-s text-large capitalize align-middle flex flex-col justify-center font-semibold text-center">Graphics design</div>
        </div>
        <div class="w-52 h-36 mx-5 relative my-6">
            <span class="absolute -top-1/4 left-0 text-xlarge text-s fas fa-cogs bg-p rounded-full p-2"></span>
            <div class="w-full h-5/6 border-4 border-d rounded-md text-s text-large capitalize align-middle flex flex-col justify-center font-semibold text-center">General Software development</div>
        </div>
        <div class="w-52 h-36 mx-5 relative my-6">
            <span class="absolute -top-1/4 left-0 text-xlarge text-s fas fa-smile-wink bg-p rounded-full p-2"></span>
            <div class="w-full h-5/6 border-4 border-d rounded-md text-s text-large capitalize align-middle flex flex-col justify-center font-semibold text-center">Quotes</div>
        </div>
    </div>
        ...
        <div class="w-full flex flex-wrap items-start justify-center">
            <a href="" class="block w-96 h-64 my-6 border-4 border-solid rounded-md border-collapse border-s hover:border-2 hover:border-dashed relative mx-2">
                ...
                <div class="w-full h-full absolute overflow-y-clip flex flex-col justify-center bg-slate-900 bg-opacity-40">
                    <div class="w-full text-center py-1 text-d text-medium uppercase font-bold">Web Development</div>
            ...
            <a href="" class="block w-96 h-64 my-6 border-4 border-solid rounded-md border-collapse border-s hover:border-2 hover:border-dashed relative mx-2">
                ...
                <div class="w-full h-full absolute overflow-y-clip flex flex-col justify-center bg-slate-900 bg-opacity-40">
                    <div class="w-full text-center py-1 text-d text-medium uppercase font-bold">Mobile Development</div>
            ...
            <a href="" class="block w-96 h-64 my-6 border-4 border-solid rounded-md border-collapse border-s hover:border-2 hover:border-dashed relative mx-2">
                ...
                <div class="w-full h-full absolute overflow-y-clip flex flex-col justify-center bg-slate-900 bg-opacity-40">
                    <div class="w-full text-center py-1 text-d text-medium uppercase font-bold">SEO</div>
            ...
            <a href="" class="block w-96 h-64 my-6 border-4 border-solid rounded-md border-collapse border-s hover:border-2 hover:border-dashed relative mx-2">
                ...
                <div class="w-full h-full absolute overflow-y-clip flex flex-col justify-center bg-slate-900 bg-opacity-40">
                    <div class="w-full text-center py-1 text-d text-medium uppercase font-bold">Graphics Design</div>
            ...
            <a href="" class="block w-96 h-64 my-6 border-4 border-solid rounded-md border-collapse border-s hover:border-2 hover:border-dashed relative mx-2">
                ...
                <div class="w-full h-full absolute overflow-y-clip flex flex-col justify-center bg-slate-900 bg-opacity-40">
                    <div class="w-full text-center py-1 text-d text-medium uppercase font-bold">General Software Development</div>
            ...
            <a href="" class="block w-96 h-64 my-6 border-4 border-solid rounded-md border-collapse border-s hover:border-2 hover:border-dashed relative mx-2">
                ...
                <div class="w-full h-full absolute overflow-y-clip flex flex-col justify-center bg-slate-900 bg-opacity-40">
                    <div class="w-full text-center py-1 text-d text-medium uppercase font-bold">Quotes</div>
