<div class="w-full">
    <div class="w-11/12 md:w-5/6 mx-auto py-8">
        <div class="w-3/4 mx-auto sm:grid grid-cols-7 my-8">
            <div class="col-span-3 text-center text-blue-600 text-6xl font-semibold text-opacity-80 h-full items-center justify-center align-middle flex flex-wrap mix-blend-hard-light bg-blend-overlay">The customized market for you</div>
    ...
    <div class="w-11/12 md:w-5/6 mx-auto py-8">
        <div class="w-full sm:grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4">
            @if(count($data)>0)
